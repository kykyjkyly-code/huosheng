...
/*
功能流程：
1. 本文件负责射门前的拿球：先靠近球，再绕到球门反方向，最后慢慢贴近球。
...
PlayerTask player_plan(const WorldModel* model, int robot_id)
{
	...
	*/
	...
	// 球在运动中时，不追球：退到球门反方向等待球停下，避免车壳顶着滚动球跑。
	// 如果球持续运动超过最大等待帧数，降级为正常状态机拿球兜底。
